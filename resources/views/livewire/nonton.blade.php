                                        ...
                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">
                                                    Kategori</td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ ucfirst($detailNonton->kategori) }}</td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">Judul
                                                </td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $detailNonton->title }}</td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">Genre
                                                </td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $detailNonton->genre }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">
                                                    Deskripsi</td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $detailNonton->deskripsi }}</td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">
                                                    Episode</td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $detailNonton->episode }}</td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">Status
                                                </td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $detailNonton->status }}</td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">Tahun
                                                    Rilis</td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $detailNonton->tahun_rilis }}</td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">Studio
                                                </td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $detailNonton->studio }}</td>
                                            </tr>
                                            <tr>
                                                <td class="px-4 py-2 font-semibold text-gray-700 dark:text-white">Rating
                                                </td>
                                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">★{{ $detailNonton->rating }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
            ...
            <div>
                ...
                @elseif ($Menu == 'tambah')
                    ...
                    <div class="md:flex p-6 border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700"
                        ...
                        <!-- Bagian Data -->
                        <div class="md:w-full md:pl-6">
                            <form wire:submit.prevent="simpan" action="#" method="POST" enctype="multipart/form-data">
                                <div class="mb-4">
                                    <label for="kategori"
                                        class="block text-sm font-medium text-gray-700 dark:text-white">Kategori</label>
                                ...
                                <div class="mb-4">
                                    <label for="tahun_rilis"
                                        class="block text-sm font-medium text-gray-700 dark:text-white">Tahun
                                        Rilis</label>
                                    <input wire:model="tahun_rilis" type="number" id="tahun_rilis"
                                        name="tahun_rilis"
                                        class="mt-1 block w-full p-2 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                        placeholder="Masukkan tahun rilis">
                                </div>
