<div class="p-4">
    <div>
        ...
        <div>
            {{-- Kalo bisa buat seperti ini --}}
            {{--
            @if ($Kategori=='anime')
                tamplikan data anime menggunakan foreach, dan tambahkan tombol detil
            @elseif ($Kategori=='donghua')
                tampilkan data donghua menggunakan foreach, dan tambahkan tombol detil
            @endif

            lalu baru abuat tombol tambah, cikup satu form, biar pengkategoriannya menggunakan formkategori
            ...
            @elseif ($Kategori == 'donghua')
                @foreach ($donghuas as $donghua)
                    <div class="relative group overflow-hidden rounded-lg shadow-lg cursor-pointer">
                        <img src="{{ asset('storage/' . $donghua->gambar) }}" alt="Donghua"
                            class="w-full h-auto transition-transform duration-300 group-hover:scale-105">
                        <div class="absolute top-2 left-2 bg-gray-900 text-white text-xs px-2 py-1 rounded">
                ...
                <div>
                    ...
                    @elseif ($Menu == 'tambah')
                        ...
                        <div class="md:flex p-6 border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700"
                            ...
                            <!-- Bagian Data -->
                            <div class="md:w-full md:pl-6">
                                <form wire:submit.prevent="simpan" action="#" method="POST"
